...
export const CAPABILITY_LABELS: Record<Capability, string> = {
  ...
  CONCIERGE_CRITIC_PASS: 'Concierge: Critic Pass',
  COMPOSE_NOTE_BY_NOTE: 'Compose Note by Note',
  COMPOSE_LICK_BY_LICK: 'Compose Lick by Lick',
  ARRANGE_FULL_TRACK: 'Arrange Full Track',
  PLAY_DRUMS: 'Play Drums',
  ...
  PUBLISH: 'Publish',
  ENFORCE_CONTINUITY_BIBLE: 'Enforce Continuity Bible',
  GENERATE_HOOK_VARIANTS: 'Generate Hook Variants',
  RUN_THUMBNAIL_DUEL: 'Run Thumbnail Duel',
  RUN_SOCIAL_AUTOPILOT_PLAYBOOK: 'Run Social Autopilot Playbook',
  RUN_CODE: 'Run Code',
  ROUTE_JOB: 'Route Job',
}
